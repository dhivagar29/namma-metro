...
function App() {
 ...
 return <main>
  ...
  <div className="view-label"><span className="live-dot"/> CAB 01 / SEATED DRIVER<small>BENGALURU · DUSK SERVICE</small><span className="cab-tag">6 CAR · PURPLE LIVERY</span></div>
  ...
  <section className="console" aria-label="Driver dashboard">
   <div className="console-top"><span>BMRCL <b>DRIVER DESK / 06</b></span><span className="console-status">● {status}</span><span lang="kn">ನಮ್ಮ ಮೆಟ್ರೋ</span></div>
